...
Widget _buildLogPage(BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            margin: EdgeInsets.fromLTRB(28 * fem, 0 * fem, 37 * fem, 160 * fem),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  // frame3Jzp (29:185)
                  margin:
                      EdgeInsets.fromLTRB(0 * fem, 0 * fem, 6 * fem, 18 * fem),
                ...
                Container(
                  ...
                  padding:
                      EdgeInsets.fromLTRB(13 * fem, 7 * fem, 13 * fem, 6 * fem),
                  width: 312 * fem,
          ...
          Container(
            ...
            margin: EdgeInsets.fromLTRB(126 * fem, 0 * fem, 130 * fem, 0 * fem),
            width: double.infinity,
            height: 5 * fem,
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(100 * fem),
